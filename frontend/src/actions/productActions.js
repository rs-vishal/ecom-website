...
// This code fetches a list of products from an API based on a keyword and updates the application state 
...
// The ListproductbyCg function fetches products by category from an API and updates the state to reflect loading, 
// success with product data, or failure with an error message.
